...
map('n', '<leader>fg', ':lua require("telescope").extensions.live_grep_args.live_grep_args()<CR>',
    { noremap = true, silent = true })
map('n', '<Leader>fG', ':lua require("telescope.builtin").live_grep({hidden=true, no_ignore=false})<Cr>',
    { noremap = true, silent = true })
map('n', '<Leader>fb', ':Telescope buffers<Cr>', { noremap = true, silent = true })
-- show class properties and methods
map('n', '<Leader>fs', ':lua require("telescope.builtin").lsp_document_symbols({symbols = {"property", "method"}})<Cr>',
    { noremap = true, silent = true })
-- show references
